...
function verifieUrl($idVisiteur, $pdo)
{
    ...
    $datas['uc']['validerFrais']['action']['supprimerFrais'] = '';  
                             ...
                             if(key($params) == $kAc){
                                ...
                                if($datas[$kUc][$kCt][$kAc]){ 
                                    ...
                                    foreach ($datas[$kUc][$kCt][$kAc] as $kLac => $vLac) {
                                         ...
                                         echo "count(datas[kUc][kCt][kAc])".count($datas[$kUc][$kCt][$kAc]);
                                         echo "<br>";
                                         */
                                                 ...
                                                 foreach ($datas[$kUc][$kCt][$kAc][$kLac] as $kId => $vId) {
                                                     ...
                                                     if(is_array($datas[$kUc][$kCt][$kAc][$kLac])){
                                                        ...
                                                        if(key($params) == $kId){
                                                            ...
                                                            if(key($params) == 'idFrais' && !$pdo->estUnFraisHorsForfait(current($params), $idVisiteur, getMois(date('d/m/Y')))){
